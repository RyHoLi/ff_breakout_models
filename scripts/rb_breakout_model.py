...
final_df.sort_values(by=['prob_1', 'prob_pred_fpts'], ascending=False).to_csv('C:/Users/Ryan/Documents/nfl_models/breakout_players/data/rb_breakout_predictions.csv', index=False)